package com.posse.android1.notes.viewHolder;
...
public class ViewHolderAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolderAdapter(NoteListFragment fragment, float headerTextSize, float noteTextSize) {
        mFragment = fragment;
        mInflater = fragment.getLayoutInflater();
        mDataSource = NoteSourceFirestoreImpl.getInstance();
